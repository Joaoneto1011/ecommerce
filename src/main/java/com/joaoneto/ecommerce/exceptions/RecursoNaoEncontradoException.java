...
public class RecursoNaoEncontradoException extends RuntimeException {
    ...
    public RecursoNaoEncontradoException(String nomeRecurso, String campo, String valorCampo) {
        super(String.format("%s nao encontrado com %s: %s", nomeRecurso, campo, valorCampo));
    }
}